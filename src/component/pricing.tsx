...
export function Pricing(): JSX.Element {
  return (
    <section id="pricing" className="bg-white py-16 dark:bg-[#2a2b30]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <motion.div
            ...
            className="overflow-hidden rounded-xl border border-gray-200 shadow-md dark:border-gray-800 dark:shadow-white"
          >
            <div className="p-6">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-xl border-2 border-blue-500 shadow-md dark:border-blue-600 dark:shadow-white"
          >
